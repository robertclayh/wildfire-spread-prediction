...
Table~\ref{tab:robustness_slices} summarizes the resulting F1 and AP scores. Both stressors reduce accuracy: strong-wind tiles incur roughly six-point drops in both F1 (0.49 vs.
0.55) and AP (0.46 vs.
...
\begin{itemize}
    \item Physics Prior: Chelsey Blowe
    \item Robustness Slices: Clay Harris
    \item Ablation Studies: Hannah Richardson
\end{itemize}
